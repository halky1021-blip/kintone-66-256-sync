...
FIELDS="文字列__1行__6,文字列__1行__2,文字列__1行_,文字列__1行__0,職種,現職・退社,有り無し,ラジオボタン,生年月日,年齢,ドロップダウン_1,当社との契約,文字列__1行__1,リンク,リンク_0,リンク_1,HP,ルックアップ,日付_0,日付,日付_1,日付_2,日付_3,許可区分,文字列__1行__3,インボイス,文字列__複数行_"
